...
export default function Contact() {
  return (
    <section id="contact" className="dot-grid contact-section">
      <div className="contact-gradient" />
      <ScrollReveal>
        <div className="contact-wrapper">
          <span className="contact-tag">Let's work together</span>
          <h2 className="contact-heading">
            Have an idea? Let's bring{" "}
            <span className="accent">it to life.</span>
          </h2>
          <p className="contact-text">
            I'm always open to new projects, collaborations, or just a good
            conversation about what you're building. Reach out — let's make
            something great.
          </p>
